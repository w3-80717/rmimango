    ...
    <div className="contactus">
      <div className="container">
        ...
        <p className="containers">
          <strong>Phone no:</strong> +91-22-48962640
          <br />
          <strong>Email ID:</strong> support@blobcity.com
          <br />
          <strong>Address: </strong>NIBR Corporate Park 1Aerocity, Andheri -
          Kurla Rd, Safed Pool, Shivaji Nagar, Mumbai, Maharashtra 400072.
          <br />
          <strong>Headquarters: </strong>WeWork, Enam Sambhav, G Block BKC,
          Bandra East, Mumbai.
        </p>
        ...
        <div className="submit-container">
          <button className="submit" onClick={handleContact}>
            Contact
          </button>
        </div>
      </div>
